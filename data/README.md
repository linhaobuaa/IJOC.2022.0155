...
* The link for the synthetic data sets used in Figure 4 of the paper: [Synthetic data sets with different different levels of training or testing anomalies](https://drive.google.com/file/d/1CV71PaW24BPA6o-TA42FaqnAW1PrMpuv/view?usp=sharing). Note: for problem of unzipping the file, you can refer to this [solution](https://stackoverflow.com/questions/56031185/unable-to-unzip-zip-file-on-linux-machine).
